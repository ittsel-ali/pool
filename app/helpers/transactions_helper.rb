module TransactionsHelper
	def link_to_remove_field(name, list)
		link_to("#", class: "btn btn-danger btn-circle btn-sm pull-right", onclick: "remove_fields(this, '#{list}', '#{name}')") do 
	...
	def link_to_add_fields(name, f, association, id)
		...
		link_to("#", id: name, onclick: "add_fields('#{name}','#{association}','#{escape_javascript(fields)}')", class: "btn btn-info") do 
